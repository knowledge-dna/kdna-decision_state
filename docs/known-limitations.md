...
This document declares known limitations of the kdna-decision_state domain judgment package.
This is required by the [KDNA Governance Policy](https://github.com/aikdna/KDNA/blob/main/GOVERNANCE.md).

## Scope Limitations
- This domain's judgment is bounded to its declared field: decision_state.
